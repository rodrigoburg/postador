...
function desenha_grafico(item) {
    baixa_planilha_dados(item["posicao"], function (dados) {
        ...
        if (legenda == "sim" || legenda == "Sim" || legenda == "SIM") {
            myChart.addLegend(margins.left+10,margins.top-20, width-margins.right, 200)
        }

        var colors = [
            new dimple.color("#8F7D59"),
            new dimple.color("#8F5959"),
            new dimple.color("#8F597D"),
            new dimple.color("#8F598F"),
            new dimple.color("#7D598F"),
            new dimple.color("#59598F"),
            new dimple.color("#598F7D"),
            new dimple.color("#598F59")
        ]

        myChart.defaultColors = shuffle(colors);
